...
function buildPrintStylesheet(printRootId: string, printCloneClass: string): string {
  ...
  return `@media print{html,body{margin:0!important;padding:0!important}body ${root},body ${root} *{visibility:visible!important}body>*{display:none!important}body>${root}{display:block!important}${root}{position:static!important;margin:0!important;padding:0!important}${clone}{margin:0!important;padding:0 0.5rem 0.5rem!important;max-width:100%!important;page-break-inside:avoid!important}${clone}.invoice-print-view{padding:0.25rem 0.5rem!important;gap:0.25rem!important}${clone}.invoice-print-view>*{margin-top:0.25rem!important;margin-bottom:0!important}${clone} .invoice-print-header-logo{border-bottom-width:1px!important;padding-bottom:0.25rem!important}${clone} [class*="pb-4"]{padding-bottom:0.25rem!important}${clone} [class*="py-2"]{padding-top:0.15rem!important;padding-bottom:0.15rem!important}${clone} [class*="py-3"]{padding-top:0.2rem!important;padding-bottom:0.2rem!important}${clone} [class*="p-3"]{padding:0.25rem!important}${clone} [class*="p-2"]{padding:0.2rem!important}${clone} [class*="mt-4"],[class*="mt-6"]{margin-top:0.25rem!important}${clone} [class*="pt-4"]{padding-top:0.25rem!important}${clone} table th,${clone} table td{padding-top:0.15rem!important;padding-bottom:0.15rem!important}${clone} .invoice-header-logo-img{max-height:6.5rem!important;height:6.5rem!important;width:auto!important;object-fit:contain!important}${clone} img:not(.invoice-header-logo-img){max-height:2rem!important;height:2rem!important}}@media screen{${root}{display:none!important}}`;
}
