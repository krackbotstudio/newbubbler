...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm text-pink-700 outline-none focus:bg-pink-200/70 focus:text-pink-800 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:text-pink-300 dark:focus:bg-pink-800/50 dark:focus:text-pink-100',
      className
    )}
    {...props}
  >
