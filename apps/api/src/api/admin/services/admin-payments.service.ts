...
import type { OrdersRepo, PaymentsRepo, UnitOfWork, InvoicesRepo, CustomersRepo } from '../../../application/ports';
import { ORDERS_REPO, PAYMENTS_REPO, UNIT_OF_WORK, INVOICES_REPO, CUSTOMERS_REPO } from '../../../infra/infra.module';
