...
import type { AnalyticsRepo, CustomersRepo } from '../../../application/ports';
import { ANALYTICS_REPO, CUSTOMERS_REPO } from '../../../infra/infra.module';
...
export class AdminAnalyticsService {
  ...
  async getDashboardKpis(input?: { branchId?: string | null }): Promise<{
    ...
    const totalCustomersCount = branchId
      ? await this.customersRepo.countWithOrdersInBranch(branchId)
      : await this.customersRepo.count();
